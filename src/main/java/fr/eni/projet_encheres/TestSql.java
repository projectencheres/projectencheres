...
public class TestSql implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Utilisateur utilisateurTest = new Utilisateur(3, "Jdoe", "Doe", "John",
		// "josédoe@example.com", "0123456789", "123 Main St", "75001", "Paris",
		// "password123", 100.00, false);
		// repoUtilisateur.save(utilisateurTest);
		// System.out.println(utilisateurTest);

		// Utilisateur utilisateurTest2 = new Utilisateur(4, "Jadoe", "Doe", "Janne",
		// "jannedoe@example.com", "0123456789", "anonym", "75001", "Paris",
		// "password123", 101.00, false);
		...
		// Article articleTest = new Article(4, "choco", "barre chocolaté", new
		// LocalDate(), new LocalDate(), 100.00, 200.00, "creer", 1, 1);
